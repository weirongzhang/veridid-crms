...
let W3cJwtCredentialService = class W3cJwtCredentialService {
    ...
    async verifyPresentation(agentContext, options) {
        ...
        try {
            ...
            const getTrustedCertificatesForVerification = agentContext.dependencyManager.isRegistered(x509_1.X509ModuleConfig)
                ? agentContext.dependencyManager.resolve(x509_1.X509ModuleConfig).getTrustedCertificatesForVerification
                : undefined;
            let signatureResult = undefined;
            try {
                // Verify the JWS signature
...
exports.W3cJwtCredentialService = W3cJwtCredentialService = __decorate([
