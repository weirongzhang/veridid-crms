...
let MediationRecipientApi = class MediationRecipientApi {
    ...
    async getPickupStrategyForMediator(mediator) {
        ...
        if (!mediatorPickupStrategy) {
            ...
            if (discloseForPickupV2.features?.find((item) => item.id === v2_1.V2StatusMessage.type.protocolUri)) {
                ...
                mediatorPickupStrategy = discloseForPickupV1.features?.find((item) => item.id === v1_1.V1BatchPickupMessage.type.protocolUri)
    ...
    async notifyKeylistUpdate(connection, verkey, action) {
        ...
        if (useDidKeysConnectionMetadata) {
            useDidKey = useDidKeysConnectionMetadata[messages_1.KeylistUpdateMessage.type.protocolUri] ?? useDidKey;
        }
        const message = this.mediationRecipientService.createKeylistUpdateMessage([
            new messages_1.KeylistUpdate({
                action: action ?? messages_1.KeylistUpdateAction.add,
...
exports.MediationRecipientApi = MediationRecipientApi = __decorate([
