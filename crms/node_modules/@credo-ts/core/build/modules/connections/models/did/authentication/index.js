        ...
        if (type === class_transformer_1.TransformationType.PLAIN_TO_CLASS) {
            return value.map((auth) => {
                ...
                if (auth.publicKey) {
                    ...
                    const publicKeyClass = (publicKey_1.publicKeyTypes[publicKeyJson.type] ?? publicKey_1.PublicKey);
                    ...
                    // embedded
                    const publicKeyClass = (publicKey_1.publicKeyTypes[auth.type] ?? publicKey_1.PublicKey);
