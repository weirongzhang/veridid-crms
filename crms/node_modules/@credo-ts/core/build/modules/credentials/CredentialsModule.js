...
class CredentialsModule {
    constructor(config) {
        ...
        this.config = new CredentialsModuleConfig_1.CredentialsModuleConfig({
            ...config,
            // NOTE: the credentialProtocols defaults are set in the CredentialsModule rather than the CredentialsModuleConfig to
            // avoid dependency cycles.
            credentialProtocols: config?.credentialProtocols ?? [new v2_1.V2CredentialProtocol({ credentialFormats: [] })],
        });
    }
    /**
