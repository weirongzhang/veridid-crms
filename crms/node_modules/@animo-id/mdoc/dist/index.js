...
__export(src_exports, {
  COSEKey: () => COSEKey,
  COSEKeyToRAW: () => COSEKeyToRAW,
  DataItem: () => DataItem,
  DateOnly: () => DateOnly,
  DeviceRequest: () => DeviceRequest,
  DeviceResponse: () => DeviceResponse,
  DeviceSignedDocument: () => DeviceSignedDocument,
  Document: () => Document,
  IssuerSignedDocument: () => IssuerSignedDocument,
  IssuerSignedItem: () => IssuerSignedItem,
  MDoc: () => MDoc,
  MDocStatus: () => MDocStatus,
  Verifier: () => Verifier,
  areEqualUint8Array: () => areEqualUint8Array,
  cborDecode: () => cborDecode,
  cborDecodeUnknown: () => cborDecodeUnknown,
  cborEncode: () => cborEncode,
  defaultCallback: () => defaultCallback,
  hexToUint8Array: () => hexToUint8Array,
  limitDisclosureToInputDescriptor: () => limitDisclosureToInputDescriptor,
  parseDeviceResponse: () => parseDeviceResponse,
  parseDeviceSigned: () => parseDeviceSigned,
  parseIssuerSigned: () => parseIssuerSigned,
...
var parseIssuerAuthElement = (rawIssuerAuth, expectedDocType) => {
  ...
  if (!version || (0, import_compare_versions.compareVersions)(version, "1.0") !== 0) {
...
var Verifier = class {
  ...
  async verifyDeviceResponse(input, ctx) {
    ...
    onCheck({
      status: (0, import_compare_versions2.compareVersions)(dr.version, "1.0") >= 0 ? "PASSED" : "FAILED",
