...
class SwaggerExplorer {
    ...
    exploreRoutePathAndMethod(instance, prototype, method, metatype, globalPrefix, modulePath, applicationConfig) {
        ...
        return (0, lodash_1.flatten)(allRoutePaths.map((routePath, index) => {
            ...
            const operationVersion = pathVersion !== null && pathVersion !== void 0 ? pathVersion : nonPathVersion;
            return Object.assign({ method: common_1.RequestMethod[requestMethod].toLowerCase(), path: fullPath === '' ? '/' : fullPath, operationId: this.getOperationId(instance, methodKey, operationVersion) }, apiExtension);
        }));
    }
    ...
    getNonPathVersion(methodVersion, metatype, versioningOptions) {
        ...
        const version = (_a = methodVersion !== null && methodVersion !== void 0 ? methodVersion : Reflect.getMetadata(constants_1.VERSION_METADATA, metatype)) !== null && _a !== void 0 ? _a : versioningOptions.defaultVersion;
        if (!version || version === interfaces_1.VERSION_NEUTRAL) {
            return undefined;
        }
        if (Array.isArray(version)) {
            const filtered = version.filter((v) => v !== interfaces_1.VERSION_NEUTRAL);
