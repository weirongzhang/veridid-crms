...
class Presentation extends AnoncredsObject_1.AnoncredsObject {
    static create(options) {
        ...
        try {
            ...
            presentationHandle = register_1.NativeAnoncreds.instance.createPresentation({
                presentationRequest,
        ...
        return new Presentation(presentationHandle.handle);
    }
    static fromJson(json) {
        return new Presentation(register_1.NativeAnoncreds.instance.presentationFromJson({ json: JSON.stringify(json) }).handle);
    }
    verify(options) {
        var _a;
        ...
        try {
            const presentationRequest = options.presentationRequest instanceof PresentationRequest_1.PresentationRequest
                ? options.presentationRequest.handle
                : (0, utils_1.pushToArray)(PresentationRequest_1.PresentationRequest.fromJson(options.presentationRequest).handle, objectHandles);
            verified = register_1.NativeAnoncreds.instance.verifyPresentation({
